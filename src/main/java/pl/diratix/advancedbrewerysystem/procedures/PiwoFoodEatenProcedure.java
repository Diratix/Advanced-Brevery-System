...
public class PiwoFoodEatenProcedure extends AdvancedBrewerySystemModElements.ModElement {
	public PiwoFoodEatenProcedure(AdvancedBrewerySystemModElements instance) {
		super(instance, 26);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				AdvancedBrewerySystemMod.LOGGER.warn("Failed to load dependency entity for procedure PiwoFoodEaten!");
			return;
		}
